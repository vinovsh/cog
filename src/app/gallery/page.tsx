    ...
    <>
      ...
      <section className="section">
        <div className="container-cog">
          ...
          {filtered.length === 0 ? (
            <p className="py-16 text-center text-brand-grey-light">
            ...
            {videoHighlights.map((v) => (
              ...
              >
                ...
                <span className="absolute inset-0 flex items-center justify-center">
                  <span className="flex h-14 w-14 items-center justify-center rounded-full bg-white/90 text-brand-blue-700 shadow-lg transition-transform group-hover:scale-110">
