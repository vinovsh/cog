  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-brand-blue-50 via-white to-brand-green-50">
      ...
      <div className="container-cog relative py-14 sm:py-16">
        <h1 className="text-3xl font-bold text-brand-navy sm:text-4xl">{title}</h1>
        {subtitle && (
          <p className="mt-3 max-w-2xl text-brand-grey-light">{subtitle}</p>
        )}
        <nav className="mt-4 flex items-center gap-2 text-sm text-brand-grey-light">
